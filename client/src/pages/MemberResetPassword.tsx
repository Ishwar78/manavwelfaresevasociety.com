...
import { Users, Eye, EyeOff, CheckCircle, AlertCircle } from "lucide-react";
...
export default function MemberResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await resetPassword(token!, password, "member");
        ...
        <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
          <Card className="w-full max-w-md shadow-elevated border-destructive">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => navigate("/member/forgot-password")} className="w-full">
        ...
        <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
          <Card className="w-full max-w-md shadow-elevated">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => navigate("/member/login")} className="w-full bg-primary">
