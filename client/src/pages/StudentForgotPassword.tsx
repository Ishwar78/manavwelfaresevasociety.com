...
export default function StudentForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await forgotPassword(email, "student");
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="email">Student Email / ईमेल</Label>
                <Input
                  id="email"
                  type="email"
            ...
            <div className="mt-6 text-center">
              <Link to="/student/login" className="flex items-center justify-center gap-2 text-sm text-muted-foreground hover:text-foreground">
